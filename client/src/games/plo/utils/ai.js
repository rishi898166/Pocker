...
const handleAI = (state, pushAnimationState) => {
	const { highBet, lastBet, pot } = state
	...
	switch(state.phase) {
		...
		case('betting2'):// eslint-disable-next-line
		case('betting3'):// eslint-disable-next-line
		case('betting4'):// eslint-disable-next-line
			const { 
			...
			const { 
				...
				isStraight, // eslint-disable-next-line
				isLowStraight, // eslint-disable-next-line
				concurrentCardValues, // eslint-disable-next-line
				concurrentCardValuesLow, // eslint-disable-next-line
			...
			const { 
				...
				isStraightFlush, // eslint-disable-next-line
				isLowStraightFlush, // eslint-disable-next-line
				concurrentSFCardValues, // eslint-disable-next-line
				concurrentSFCardValuesLow, // eslint-disable-next-line
			...
			const handHierarchy = [{
				...
				name: 'Straight Flush',
				match: isStraightFlush ? true : false,
			}, {
				name: 'Four Of A Kind',
				match: isFourOfAKind ? true : false,
			}, {
				name: 'Full House',
				match: isFullHouse ? true : false,
			}, {
				name: 'Flush',
				match: isFlush ? true : false
			}, {
				name: 'Straight',
				match: isStraight ? true : false,
			}, {
				name: 'Three Of A Kind',
				match: isThreeOfAKind ? true : false,
			}, {
				name: 'Two Pair',
				match: isTwoPair ? true : false,
			}, {
				name: 'Pair',
				match: isPair ? true : false,
			}, {
				name: 'No Pair',
				match: isNoPair ? true : false,
			}];
		...
		default: throw Error("Handle AI Running during incorrect phase");// eslint-disable-next-line
	}
}
